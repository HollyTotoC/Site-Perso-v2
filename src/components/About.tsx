        ...
        <section id="about" className="about">
            ...
            <div className="about_container">
                ...
                <p className="text">
                    ...
                    d'une expérience span en conseil en communication digitale,
                    j'ai décidé de me diriger vers le développement web en
                    suivant une formation chez OpenClassrooms. Compétent en
                    HTML, CSS, JavaScript, React, Bootstrap, Git, Adobe Creative
                    Suite et Figma, je suis en mesure de créer des expériences
                    web innovantes et conviviales.
                </p>
            </div>
        </section>
    );
